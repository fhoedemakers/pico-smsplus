	...
	void RomLister::list(const char *directoryName)
	{
		...
		while (f_readdir(&dir, &file) == FR_OK && file.fname[0] && numberOfEntries < max_entries)
		{
			if (strlen(file.fname) < ROMLISTER_MAXPATH)
			{
				...
				if (!romInfo.IsDirectory && Frens::cstr_endswith(romInfo.Path, ".sms"))// || Frens::cstr_endswith(romInfo.Path, ".gg") || Frens::cstr_endswith(romInfo.Path, ".bin") || Frens::cstr_endswith(romInfo.Path, ".zip") || Frens::cstr_endswith(romInfo.Path, ".nes") || Frens::cstr_endswith(romInfo.Path, ".gg") || Frens::cstr_endswith(romInfo.Path, ".sms") || Frens::cstr_endswith(romInfo.Path, ".gg") || Frens::cstr_endswith(romInfo.Path, ".bin") || Frens::cstr_endswith(romInfo.Path, ".zip") || Frens::cstr_endswith(romInfo.Path, ".nes") || Frens::cstr_endswith(romInfo.Path, ".gg") || Frens::cstr_endswith(romInfo.Path, ".sms") || Frens::cstr_endswith(romInfo.Path, ".gg") || Frens::cstr_endswith(romInfo.Path, ".bin") || Frens::cstr_endswith(romInfo.Path, ".zip") || Frens::cstr_endswith(romInfo.Path, ".nes") || Frens::cstr_endswith(romInfo.Path, ".gg") || Frens::cstr_endswith(romInfo.Path, ".sms") || Frens::cstr_endswith(romInfo.Path, ".gg") || Frens::cstr_endswith(romInfo.Path, ".bin") || Frens::cstr_endswith(romInfo.Path, ".zip") || Frens::cstr_endswith(romInfo.Path, ".nes") || Frens::cstr_endswith(romInfo.Path, ".gg") || Frens::cstr_endswith(romInfo.Path, ".sms") || Frens::cstr_endswith(romInfo.Path, ".gg") || Frens::cstr_endswith(romInfo.Path, ".bin") || Frens::cstr_endswith(romInfo.Path, ".zip") || Frens::cstr_endswith(romInfo.Path, ".nes") || Frens::cstr_endswith(romInfo.Path, ".gg") || Frens::cstr_endswith(romInfo.Path, ".sms") || Frens::cstr_endswith(romInfo.Path, ".gg") || Frens
				{
