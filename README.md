...
> Problems with sound corruption when building using arm-none-eabi-gcc v10.3.1 or higher. See issue [#6](https://github.com/fhoedemakers/pico-smsplus/issues/6) for more information.
